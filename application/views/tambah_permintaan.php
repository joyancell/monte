<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Permintaan/</span> Tambah Data</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Frekuensi permintaan Darah di tahun sebelumnya</h5>
                     
                    </div>
                    <div class="card-body">
                      <form method="post" action="<?php echo base_url() ?>permintaan/simpan">
                        <div class="mb-3 row">
                          <div class="col">
